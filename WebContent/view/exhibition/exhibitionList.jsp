...
$(function(){	 
	 ...
	 $("#searchExhibitionBtn").on("click",function(){
		 // 입력된 검색어 가져오기
		let exhibitionInput = document.getElementById("search-value").value;  //<input type="text" placeholder="사용자 검색" class="form-control" id="search-value"name="searchValue" />
		...
		if(exhibitionInput===""){ 
		 ...
		 $.ajax({
			  ...
			  url:"${cPath}/searchExhibition.do",   //요청url.예)"/board/list.do"
...
<div class="mainmenu">
                        ...
                        <div class="col-12">
                            <div class="row no-gutters">
                                <div class="col-lg-3 col-md-3 col-sm-12 p-0">
                                    ...
                                    <select class="form-control" id="search-type" name="searchType" id="searchValue">
                                        <option>검색</option>
                                        <option>NO</option>
                                        <option>전시회제목</option>
                                    </select>
                                ...
                                <div class="col-lg-8 col-md-6 col-sm-12 p-0">
                                    <input type="text" placeholder="전시회 검색" class="form-control" id="search-value" name="searchValue">
                                </div>
    ...
    <div class="row">
        <div class="d-grid gap-2 d-md-flex justify-content-md-end">
               	<input type="submit" class="btn btn-default" id="write-article" value="작성하기"/>
