...
public class OurExhibitionData {
	//필드
	...
	public String toString() {
		return "OurExhibitionData [number=" + number + ", writer_id=" + writer_id + ", writer_name=" + writer_name
				+ ", title=" + title + ", regDate=" + regDate + ", modifiedDate=" + modifiedDate + ", readCount="
				+ readCount + ", content=" + content + "]";
	}

	public void setExhibition_no(int int1) {
